...
router.register('borrowed-books', AdminBorrowedBooksController, basename='admin-borrowed-book')
...
member_router.register(r'borrowed-books', AdminBorrowedBooksController, basename='admin-member-borrowed-books')
